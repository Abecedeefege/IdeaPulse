    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid sm:grid-cols-3 gap-6">
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
          ...
          <p className="text-sm text-zinc-400 mb-4">100 ideas per day, share, view top ideas.</p>
          <Link href="/dashboard" className="block w-full text-center py-2 rounded-xl border border-zinc-600 text-zinc-300 text-sm font-medium hover:border-zinc-500">
            Get started
          </Link>
        </div>
